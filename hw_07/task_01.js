...
const arrayOfNumbers = [NaN, 1, true, 5, "hello", undefined, 15.5, {}, []];

function getOnlyNumbers(arrayOnAnyValue) {
    const result = arrayOnAnyValue.filter(numberFromArray => !isNaN(numberFromArray) && typeof numberFromArray === 'number');
    return result;
};

console.log(getOnlyNumbers(arrayOfNumbers));